...
/**
 * <b>ISoapResponseMapper</b>
 * <p>
 * This class specifies the requirements for the {@link ISoapResponseMapper} component,
 * developed in accordance with the development standards established by bxcode.
 * Collaboration is encouraged for the enhancement and expansion of the lib-web-service.
 * </p>
 * <p>
 * <b>Description:</b>
 * </p>Interfaz para el mapeo de respuestas SOAP. Proporciona un método para convertir un objeto de tipo S a un objeto de tipo T.</p>
 *
...
public interface ISoapResponseMapper<S, R> {
